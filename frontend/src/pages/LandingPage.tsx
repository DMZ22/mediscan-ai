    ...
    <div className="min-h-screen overflow-x-hidden" style={{
      ...
      <footer className="border-t border-slate-800 py-8 px-6 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 text-xs">
          ...
          <a href="https://github.com/DMZ22" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-slate-300 font-semibold hover:text-cyan-400 transition-colors">
